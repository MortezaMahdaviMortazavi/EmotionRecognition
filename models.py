...
# Prepare the data
train_loader = create_dataloader(mode='train', vocab_path='vocab.pkl', vocab_threshold=1, vocab_from_file=False, batch_size=32, shuffle=True)
test_loader = create_dataloader(mode='test', vocab_path='vocab.pkl', vocab_threshold=1, vocab_from_file=False, batch_size=32, shuffle=False)
